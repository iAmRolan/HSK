...
{
	public class UpdatingAbsenceRecord : IWebTest
	{
		...
		public ExecutionResult Execute(WebTestHelper helper)
		{
			...
			//4
			AbsencesUpdate absencesUpdate = new AbsencesUpdate();
			absencesUpdate.Mispar_Zehut = Mispar_Zehut;	
			absencesUpdate.Semel_Mosad = Semel_Mosad;	
			absencesUpdate.Ad_Taarich = Ad_Taarich;
			absencesUpdate.Me_Taarich = Me_Taarich;
			absencesUpdate.Sug_Headrut = Sug_Headrut;
			absencesUpdate.Shem_Headrut = Shem_Headrut;
			absencesUpdate.Ad_Taarich_Hadash = Ad_Taarich_Hadash;
			absencesUpdate.QueryResult = QueryResult;
			absencesUpdate.Semel_Mosad = Semel_Mosad;
			absencesUpdate.Shaot_Pitzul = Shaot_Pitzul;
			absencesUpdate.ApplicationURL = ApplicationURL;
			executionResult = managePage.Execute(helper);
